...
public class OrderController extends BaseController {
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var1", varOList.get(i).getString("FXS"));	    //1
			vpd.put("var2", varOList.get(i).getString("GYS"));	    //2
			vpd.put("var3", varOList.get(i).getString("RESERVEDATE"));	    //3
			vpd.put("var4", varOList.get(i).get("PERSONS").toString());	//4
			vpd.put("var5", varOList.get(i).get("SUM").toString());	//5
			vpd.put("var6", varOList.get(i).get("FXSPAY").toString());	//6
			vpd.put("var7", varOList.get(i).get("FXSREFUND").toString());	//7
			vpd.put("var8", varOList.get(i).get("GYSPOS").toString());	//8
