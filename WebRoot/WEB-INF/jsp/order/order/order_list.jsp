						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">分销商</th>
									<th class="center">供应商</th>
									<th class="center">预定日期</th>
									<th class="center">出团人数</th>
									<th class="center">总价</th>
									<th class="center">分销商支付</th>
									<th class="center">分销商退款</th>
									<th class="center">供应商付款</th>
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.FXS}</td>
											<td class='center'>${var.GYS}</td>
											<td class='center'>${var.RESERVEDATE}</td>
											<td class='center'>${var.PERSONS}</td>
											<td class='center'>${var.SUM}</td>
											<td class='center'>${var.FXSPAY}</td>
											<td class='center'>${var.FXSREFUND}</td>
											<td class='center'>${var.GYSPOS}</td>
